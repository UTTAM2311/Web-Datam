...
public class Verify {
    ...
    /**
     * Verifies a boolean expression, throwing {@code IllegalArgumentException} if the test result
     * is {@code false}.
     * 
    ...
    /**
     * Verify that the given String is not empty; that is, it must not be {@code null} and not the
     * empty String.
     * 
    ...
    /**
     * Verify that an array has elements; that is, it must not be {@code null} and must have at
     * least one element.
     * 
    ...
    /**
     * Verify that a Map has entries; that is, it must not be {@code null} and must have at least
     * one entry.
     * 
    ...
    /**
     * Verifies whether the value is below the lowerBound or not
     * 
     * @param value
     * @param lowerBound
     */
    public static void notLowerBounded(int value, int lowerBound) {
        if (value > lowerBound) {
            return;
        }
        throw new IllegalArgumentException("[failed] - the value is below the lower Bound");

    }

    /**
     * Verifies whether the value is above the upper Bound or not
     * 
     * @param value
     * @param upperBound
     */
    public static void notUpperBounded(int value, int upperBound) {
        if (value < upperBound) {
            return;
        }
        throw new IllegalArgumentException("[failed] - the value is above the upper Bound");

    }

    /**
     * Verifies whether the value lies in the bounded region.
     * 
     * @param value
     * @param lowerBound
     * @param upperBound
     */
    public static void notUpperBounded(int value, int lowerBound, int upperBound) {
        notLowerBounded(value, lowerBound);
        notUpperBounded(value, upperBound);
    }
