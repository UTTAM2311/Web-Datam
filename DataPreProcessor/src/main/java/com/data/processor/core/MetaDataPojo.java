...
public class MetaDataPojo {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(uRL).append(title).append(description).append(category).append(tags)
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(uRL, rhs.uRL).append(title, rhs.title).append(description, rhs.description)
