...
public class PrimitiveUtil {
    ...
    /**
     * Converts to array of corresponding primitive class type. All the null values will be replaced
     * with default value.
     * 
     * @param inArray Array of wrapper class type
     ...
     * 
     * @param inArray Array of wrapper class type
     * @param valueForNull Value to use as replacement for null.
     * @return Array of corresponding primitive class type
     */
     ...
     * 
     * @param collection any {@link Collection} of {@link Double}
     ...
     * 
     * @param dArray 2 dimensional array of double
